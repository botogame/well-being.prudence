...
> Хаос или некромантия - матриархат симуляции мужчин состоящий из денег и войны.
>
> Лозунг: кто с мечом к нам придёт, тот от меча и погибнет.
> 
> В порядке иначе: вместо денег - создаётся потребность для нужд (а не войны).
