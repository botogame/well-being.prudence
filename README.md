...
Создал прототип катализатора ритмов на систему windows: <a href="https://колыбель-свободы.рф/Колыбель_Свободы.zip">скачать</a>. В программу встроено обновление.
