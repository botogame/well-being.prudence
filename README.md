...
1. Унисон романтики = источник привилегии от куратора Солнце
2. Унисон справедливости = источник привилегии от куратора Воздух
3. Унисон искренности = источник привилегии от куратора Вода
4. Унисон спокойствия = источник привилегии от куратора Земля
...
- Мысль №1: О взаимодействии с кураторами там: http://пасьянс-медичи.рф
- Мысль №2: От каждого куратора есть территория воздействия, с различными типами источников, но о них потом.
- Мысль №3: Кураторы наделяют человека привилегиями на определенной территории земли.
...
- Мысль №3: Чтобы понять хронос, можно заменить его словом нужность, или словом деньги, которые хотят попасть к вам в руки, побуждая на деятельность.
