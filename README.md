...
> Обладатель денег - обладает интересом способным высвобождать потенциал других. Промежуточным состоянием между интересом и потенциалом является интеграция (потребность + нужда).
