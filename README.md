...
Основываясь на <a href="./Прототипы/Катализатор%20талантов/README.md">катализатор талантов</a> я попробую спланировать такую игру, где будут учитываться параметры:
1. Поле
2. Лабиринты
3. Свобода
4. Участники
