...
3. На третьем месте дети (свои дети, животные, растения и т.д.). Обучение ответственности и лишения прав.
4. На четвёртом месте родственники (родители, внуки, друзья и т.д.). Обучение родству и отчуждению.
