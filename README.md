...
- Update 1: Заметил что сейчас почему то некоторые мужчины опускаются до нижних чакр, а женщины поднимаются на верхние... что не соотвествует заложенным в тело функциям, видимо это какая то давняя недоработка наших создателей. Мужчине нужно работать на верхних чакрах, а женщине только на нижних. Она же всё таки должна следить за родами и содержать дом в чистоте, а не он.

- Update 2: Чтобы прийти в себя мужчине нужно принять актитропил, а женщине пенталгин.

- Update 3: Если вы не занимались какой то чакрой, то она находится на фазе зарождения. И желательно чтобы для мужчины чакры души, а для женщины чакры духа, так и оставались на этой фазе зарождения. Если же у вас произошло развитие несвойственных вашему полу чакр, их можно вернуть в первоначальную фазу с помощью аннигиляции.
...
1. Унисон романтики = источник куратора Солнце
2. Унисон справедливости = источник куратора Воздух
3. Унисон искренности = источник куратора Вода
4. Унисон спокойствия = источник куратора Земля

Унисон это считывание вибраций с источников куратора, нарабатывается практиками и различными взаимодействиями на данной территории. Чем больше уровень считывания, тем сильнее (или мощнее) чакра может заряжаться и в дальнейшем шире проявлять себя.

- Update 1: о взаимодействии с кураторами там: http://пасьянс-медичи.рф
- Update 2: от каждого куратора есть территория воздействия, с различными типами источников, но о них потом.
...
- Update 1: религии и опг - это паразиты внутри тела государства, представители хаоса, и первое что они воруют у государства - время, потом переходят на стабильность.
- Update 2: порядок отживания оптимально подходит для избавления от воров и здесь проще получить контакт со своей половинкой с наименьшими усилиями, когда государство в хаосе.
- Update 3: коронавирус, как бы не был человеку плох, но он сейчас единственный кто возвращает государствам стабильность.
- Update 3: чтобы понять хронос, можно заменить его словом нужность, или словом деньги, которые хотят попасть к вам в руки, побуждая на деятельность.
