...
Чем хуже положение у половинок, тем проще нужен порядок для активации регулятора. Процент неприкаянности означает системные ошибки, от которых не избавиться.
