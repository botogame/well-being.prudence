...
2. Дух сахасрара
   ...
   2.4. Унисон спокойствия
        ...
        2.4.2. Культура выживания = состояние непривязанности
               🎼 ТУ-134 – Память папы
        2.4.3. Культура доживания = состояние отрешённости
...
5. Душа анахата
   ...
   5.2. Унисон безжалостности
        5.2.1. Культура жизни = состояние сопровождения
               🎼 Калинов мост - Родная
        5.2.2. Культура выживания = состояние наблюдения
               🎼 Enjoykin - Полковник
        5.2.3. Культура доживания = состояние наступления
               🎼 Сплин - Линия Жизни
        5.2.4. Культура отживания = состояние ?
   5.3. Унисон искренности
        5.3.1. Культура жизни = состояние последушки
               🎼 Erasure - Breathe
        5.3.2. Культура выживания = состояние суверенитета
               🎼 izzamuzzic - ice
   ...
   5.4. Унисон спокойствия
        ...
        5.4.2. Культура выживания = состояние предостережений
               🎼 IC3PEAK - Плак-Плак
        5.4.3. Культура доживания = состояние вредных советов
               🎼 La Caravane Passe (feat. R.Wan) - ZINZIN MORETTO 
        5.4.4. Культура отживания = состояние лжи
...
6. Честь муладхара
   ...
   6.2. Унисон безжалостности
        6.2.1. Культура жизни = состояние потребностей
               🎼 Свидание - Я и твой кот
        6.2.2. Культура выживания = состояние лучшего
               🎼 GroTTesque - Стальное Сердце
               🎼 El Alfa - Mera Woo
        6.2.3. Культура доживания = состояние балбеса
               🎼 Enjoykin — Nyash Myash
        6.2.4. Культура отживания = состояние неразборчивости
               🎼 Enjoykin - Crazy Midnight Display
   6.3. Унисон искренности
        6.3.1. Культура жизни = состояние воспоминаний
               🎼 Смысловые Галлюцинации - Волшебный Мир
        6.3.2. Культура выживания = состояние отвлечения
               🎼 Альянс - На заре
        6.3.3. Культура доживания = состояние ?
        6.3.4. Культура отживания = состояние ?
   6.4. Унисон спокойствия
        6.4.1. Культура жизни = состояние требований
               🎼 Soviet Suprem - Bolchoï
               🎼 Цой - Весь мир идет на меня войной
        6.4.2. Культура выживания = состояние подмечания
               🎼 Enjoykin - Семечки
        6.4.3. Культура доживания = состояние ?
        6.4.4. Культура отживания = состояние попадалова
               🎼 Enjoykin - Мухи
...
7. Честь свадхистхана
   7.1. Унисон романтики
        7.1.1. Культура жизни = состояние дела
               🎼 Невиди́мка — Звезда
        7.1.2. Культура выживания = состояние задумчивости
               🎼 Небо Пополам - Весна
        7.1.3. Культура доживания = состояние ?
        7.1.4. Культура отживания = состояние отлынивания
   ...
   7.3. Унисон искренности
        7.3.1. Культура жизни = состояние заинтересованности
               🎼 Enjoykin — Привет! Как Дела
        7.3.2. Культура выживания = состояние приятельства
               🎼 Аквариум - Марш Священных Коров
        7.3.3. Культура доживания = состояние надежд
               🎼 Enjoykin — Офицер
   ...
   7.4. Унисон спокойствия
        ...
        7.4.2. Культура выживания = состояние изящества
               🎼 Gorillaz - Stylo
        7.4.3. Культура доживания = состояние обломов
               🎼 Сидоджи Дубоshit и Грязный Рамирес - Джин Grey
        7.4.4. Культура отживания = состояние растяпы
