...
1. Порядок жизни = золотое время: 60%-100% свободы, 0%-40% неприкаянности
2. Порядок выживания = серебрянное время: 50%-60% свободы, 40%-50% неприкаянности
3. Порядок доживания = железное время: 10%-50% свободы, 50%-90% неприкаянности
4. Порядок отживания = титановое время: 0%-10% свободы, 90%-100% неприкаянности
...
- Update 3: чтобы понять время, можно заменить его словом нужность, или словом деньги, которые хотят попасть к вам в руки.
