...
2. На втором месте вторая половинка (Я + вторая половика = семья). Обучение синхронизации и рассинхронизации: мы это только мы.
3. На третьем месте дети (свои дети, животные, растения и т.д.). Обучение ответственности и лишения прав: моё есть моё.
