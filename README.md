...
У каждого сезона (порядка) чакры обретают иные состояния, более подробный список состояний от государства я привожу здесь: <a href="./Состояния.md">Состояния</a>
