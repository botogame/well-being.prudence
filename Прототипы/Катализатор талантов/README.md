...
```diff
   ...
   2.4. Куратор спокойствия
        ...
        2.4.6. Честь сакральности = талант "Доверие"
...
```diff
   ...
   4.3. Куратор искренности
        4.3.1. Дух короны = талант "Измена"
